...
def main():
    ...
    metrics_fname = str(sys.argv[2]+"/"+sys.argv[3]+'-resources_metrics.txt')
    ...
    with open(metrics_fname, 'w+') as f:
        while True:
            ...
            # 
            # resources_metrics = str(np.hstack((time, memory_rss, memory_rss,
            #                             memory_vms, memory_shr, core_usage,
            #                             num_threads, data, io_reads, io_writes)))
            # print(resources_metrics)
